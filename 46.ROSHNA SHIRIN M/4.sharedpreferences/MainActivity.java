    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mobilei.isEmpty()){
                    mobilenum.setError("mobilenumber is empty");
                ...
                if (pass2s.isEmpty()){
                    pass2.setError("username is empty");
                    pass2.requestFocus();
                    return;
                }
                if (pass1s.length()<6){
                    pass1.setError("length must be minimum6characters");
                    pass1.requestFocus();
                    return;
                }
                if(!pass1s.equals(pass2s)){
                    pass2.setError("passwordnot matched");
                    pass2.requestFocus();
                    return;
                }
